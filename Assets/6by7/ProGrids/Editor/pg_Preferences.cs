...
public class pg_Preferences {
	...
	public static float ALPHA_BUMP = .06f;
	...
	public static bool LoadPreferences()
	{
		...
		_useAxisConstraints = (EditorPrefs.HasKey(pg_Constant.UseAxisConstraints)) ? EditorPrefs.GetBool(pg_Constant.UseAxisConstraints) : USE_AXIS_CONSTRAINTS;
	...
	public static void SetPreferences()
	{
		...
		EditorPrefs.SetBool(pg_Constant.UseAxisConstraints, _useAxisConstraints);
